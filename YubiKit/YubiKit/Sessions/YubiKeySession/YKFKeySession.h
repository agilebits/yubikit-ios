...
/**
 * ---------------------------------------------------------------------------------------------------------------------
 * @name YKFKeySession Types
 * ---------------------------------------------------------------------------------------------------------------------
 */

/*!
 Defines the states of the YKFKeySession.
 */
typedef NS_ENUM(NSUInteger, YKFKeySessionState) {
    
    /// The session is closed. No commands can be sent to the key.
    YKFKeySessionStateClosed,
    
    /// The session is opened and ready to use. The application can send immediately commands to the key.
    YKFKeySessionStateOpen,
 ...
 */
@property (nonatomic, assign, readonly) YKFKeySessionState sessionState;
 ...
 */
@property (nonatomic, readonly, nullable) YKFKeyDescription *keyDescription;
...
/*!
 @constant YKFKeySessionStatePropertyKey
 ...
 */
extern NSString* const YKFKeySessionStatePropertyKey;

/*!
 @constant YKFKeySessionU2FServicePropertyKey
 
 @abstract
    Helper property name to setup KVO paths in ObjC. For Swift there is a better built-in language support for composing keypaths.
 */
extern NSString* const YKFKeySessionU2FServicePropertyKey;

/*!
 @constant YKFKeySessionFIDO2ServicePropertyKey
 
 @abstract
    Helper property name to setup KVO paths in ObjC. For Swift there is a better built-in language support for composing keypaths.
 */
extern NSString* const YKFKeySessionFIDO2ServicePropertyKey;
